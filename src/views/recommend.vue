<template>
  <div>
    <div class="block recommend wow slideInRight">
      ...
      <div>
        <ul>
          <li :key="index" v-for="(item, index) in ArrayBlog">
            <a href="http://wwww.baidu.com" target="_blank">{{ item }}</a>
          </li>
        </ul>
      </div>
      ...
      <div>
        <ul>
          <li :key="index" v-for="(item, index) in ArrayStudy">
      ...
      <div>
        <ul>
          <li :key="index" v-for="(item, index) in production">
            <a :href="item.url" target="_blank">{{ item.name }}</a>
          </li>
        </ul>
      </div>
      ...
      <div>
        <ul>
          <li :key="index" v-for="(item, index) in learning">
            <router-link to="/LearningPath">{{ item.name }}</router-link>
          </li>
        </ul>
      </div>
    </div>
